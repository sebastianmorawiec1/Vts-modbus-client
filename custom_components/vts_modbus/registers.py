...
Zvendorowana wersja logiki z pakietu vts_modbus (biblioteki niezależnej),
aby custom_component Home Assistant nie zależał od dodatkowego pakietu
spoza PyPI.
"""
...
def load_registers_from_yaml(path: str) -> Dict[str, RegisterDefinition]:
    """Ładuje mapę rejestrów z pliku YAML (opcjonalne nadpisanie domyślnych)."""
    import yaml

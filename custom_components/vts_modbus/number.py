"""Platforma number dla VTS Modbus (zapisywalne nastawy w rejestrach holding)."""
...
class VTSNumber(CoordinatorEntity[VTSModbusCoordinator], NumberEntity):
    ...
    def __init__(self, coordinator: VTSModbusCoordinator, entry: ConfigEntry, name: str) -> None:
        ...
        # Wartości domyślne, jeśli w mapie rejestrów nie podano min/max/step —
        # dopasuj je do rzeczywistego zakresu danego parametru swojej centrali.
